        ...
        <div className='w-full  backdrop-blur-2xl bg-gradient-to-t from-dark-4 to-dark-4/70 drop-shadow-2xl '>
          ...
          <div className='flex  p-8 xl:w-[90%] mx-auto flex-col'>
            ...
            <div className='grid grid-cols-5 gap-1 '>
              ...
              <div className='w-full rounded-r-2xl rounded-bl-2xl overflow-hidden col-span-1 order-3
              ...
              <div className='h-40 overflow-hidden col-span-3 order-4 md:col-span-5 lg:col-span-3'>
              ...
              <div className='col-span-5 order-5 lg:col-span-2'>
